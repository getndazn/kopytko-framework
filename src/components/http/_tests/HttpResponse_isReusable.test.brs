function TestSuite__HttpResponse_isReusable() as Object
  ...
  it("should return false for no Cache-Control header", function (_ts as Object)
    ' Given
    props = {
      id: "123456",
      httpStatusCode: 200,
  ...
  it("should return false for no-store value in the Cache-Control header", function (_ts as Object)
    ' Given
    props = {
      id: "123456",
      httpStatusCode: 200,
  ...
  it("should return true for no no-store value in the Cache-Control header", function (_ts as Object)
    ' Given
    props = {
      id: "123456",
      httpStatusCode: 200,

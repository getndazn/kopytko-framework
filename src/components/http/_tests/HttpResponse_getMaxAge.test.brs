function TestSuite__HttpResponse_getMaxAge() as Object
  ...
  it("returns MAX_AGE_NOT_ALLOWED for no-cache header", function (_ts as Object)
    ' Given
    props = {
      id: "123456",
      httpStatusCode: 200,
  ...
  it("returns max-age value of Cache-Control header", function (_ts as Object)
    ' Given
    props = {
      id: "123456",
      httpStatusCode: 200,
  ...
  it("returns time left based on Expires value if no Cache-Control header", function (_ts as Object)
    ' Given
    mockFunction("imfFixdateToSeconds").implementation(function (params as Object, _m as Object)
  ...
  it("returns MAX_AGE_NOT_ALLOWED if Expires value is in the past and if no Cache-Control header", function (_ts as Object)
    ' Given
    mockFunction("imfFixdateToSeconds").implementation(function (params as Object, _m as Object)
      if params.imfFixdate = "Tue, 20 Apr 2022 04:20:00 GMT"
        return 400 ' different than header value but it does not matter
  ...
  it("returns 0 if no Expires or Cache-Control header", function (_ts as Object)
    ' Given
    props = {
      id: "123456",
      httpStatusCode: 200,

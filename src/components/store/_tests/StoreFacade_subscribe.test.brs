function TestSuite__StoreFacade_subscribe() as Object
  ...
  it("should add 1 subscriber", function (_ts as Object)
    ' Given
    store = StoreFacade()
  ...
  it("should add 2 subscribers", function (_ts as Object)
    ' Given
    store = StoreFacade()
  ...
  it("should call callback in sequence", function (_ts as Object)
    ' Given
    store = StoreFacade()
  ...
  it("should call callback with the given context when it is provided", function (_ts as Object)
    ' Given
